...
public class CalibrateSleep {

    public static final String TABLE_NAME = "calibrateSleep";
    ...
    public CalibrateSleep(){}

    public CalibrateSleep(int id, long startTimestamp, long endTimestamp){
        this.id = id;
